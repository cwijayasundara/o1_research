...
o1_preview = init_chat_model('o1-preview',
...
if add_radio == 'o1_preview':
    chains.set_llm(o1_preview)
elif add_radio == 'o1_mini':
...
if language and submit and request and app_name:
    ...
    requirements = product_manager_chain.invoke(request)
    ...
    tech_design = tech_lead_chain.invoke({'language': language, 'input': request})
    ...
    test_plan = test_lead_chain.invoke(requirements)
    ...
    file_structure = file_structure_chain.invoke({'language': language, 'input': tech_design})
    ...
    files = file_path_chain.invoke({'language': language, 'input': file_structure})
